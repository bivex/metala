...
from metala.application.dto import (
...
from metala.domain.events import (
    ParsingJobCompleted,
    ParsingJobStarted,
    SourceUnitParsed,
    SourceUnitParsingFailed,
)
from metala.domain.model import ParseOutcome, ParseStatus, ParsingJob, SourceUnit
from metala.domain.ports import (
    Clock,
