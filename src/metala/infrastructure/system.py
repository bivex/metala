...
from metala.domain.model import ParsingJob
from metala.domain.ports import Clock, DomainEventPublisher, ParsingJobRepository
...
class StructuredLoggingEventPublisher(DomainEventPublisher):
    def __init__(self, logger: logging.Logger | None = None) -> None:
        self._logger = logger or logging.getLogger("metala.events")
